...
{
    public class HomensExpressionBuilder<T> where T : class
    {
        ...
        public HomensExpressionBuilder(string obj)
        {
        ...
        public HomensExpressionBuilder<T> BuscarEmTudo(string? search)
        {
            if (!string.IsNullOrWhiteSpace(search))
            {
                search = search.Trim();

                var nomeProperty = Expression.Property(View, nameof(HomensVm.NomeCompleto));
                var nome = Expression.Call(nomeProperty, MethodInfoContains!, Expression.Constant(search));

                var regiaoProperty = Expression.Property(View, nameof(HomensVm.Regiao));
                ...
                var igrejaProperty = Expression.Property(View, nameof(HomensVm.Igreja));
                ...
                {
                    var cargoLocalProperty = Expression.Property(View, nameof(HomensVm.CargoLocal));
                ...
                {
                    var cargoRegionalProperty = Expression.Property(View, nameof(HomensVm.CargoRegional));
