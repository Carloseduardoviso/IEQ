...
{
    public class JovemAdolescenteExpressionBuilder<T> where T : class
    {
        ...
        public JovemAdolescenteExpressionBuilder(string obj)
        {
        ...
        public JovemAdolescenteExpressionBuilder<T> BuscarEmTudo(string? search)
        {
            if (!string.IsNullOrWhiteSpace(search))
            {
                search = search.Trim();

                var nomeProperty = Expression.Property(View, nameof(JovemAdolescenteVm.NomeCompleto));
                var nome = Expression.Call(nomeProperty, MethodInfoContains!, Expression.Constant(search));

                var regiaoProperty = Expression.Property(View, nameof(JovemAdolescenteVm.Regiao));
                ...
                var igrejaProperty = Expression.Property(View, nameof(JovemAdolescenteVm.Igreja));
                ...
                {
                    var cargoLocalProperty = Expression.Property(View, nameof(JovemAdolescenteVm.CargoLocal));
                ...
                {
                    var cargoRegionalProperty = Expression.Property(View, nameof(JovemAdolescenteVm.CargoRegional));
