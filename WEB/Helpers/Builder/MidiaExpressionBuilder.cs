...
{
    public class MidiaExpressionBuilder<T> where T : class
    {
        ...
        public MidiaExpressionBuilder(string obj)
        {
        ...
        public MidiaExpressionBuilder<T> BuscarEmTudo(string? search)
        {
            if (!string.IsNullOrWhiteSpace(search))
            {
                search = search.Trim();

                var nomeProperty = Expression.Property(View, nameof(MidiaVm.NomeCompleto));
                var nome = Expression.Call(nomeProperty, MethodInfoContains!, Expression.Constant(search));

                var regiaoProperty = Expression.Property(View, nameof(MidiaVm.Regiao));
                ...
                var igrejaProperty = Expression.Property(View, nameof(MidiaVm.Igreja));
                ...
                {
                    var cargoLocalProperty = Expression.Property(View, nameof(MidiaVm.CargoLocal));
                ...
                {
                    var cargoRegionalProperty = Expression.Property(View, nameof(MidiaVm.CargoRegional));
