...
{
    public class DancaExpressionBuilder<T> where T : class
    {
        ...
        public DancaExpressionBuilder(string obj)
        {
        ...
        public DancaExpressionBuilder<T> BuscarEmTudo(string? search)
        {
            if (!string.IsNullOrWhiteSpace(search))
            {
                search = search.Trim();

                var nomeProperty = Expression.Property(View, nameof(DancaVm.NomeCompleto));
                var nome = Expression.Call(nomeProperty, MethodInfoContains!, Expression.Constant(search));

                var regiaoProperty = Expression.Property(View, nameof(DancaVm.Regiao));
                ...
                var igrejaProperty = Expression.Property(View, nameof(DancaVm.Igreja));
                ...
                {
                    var cargoLocalProperty = Expression.Property(View, nameof(DancaVm.CargoLocal));
                ...
                {
                    var cargoRegionalProperty = Expression.Property(View, nameof(DancaVm.CargoRegional));
