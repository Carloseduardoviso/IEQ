...
namespace WEB.Models.Entities
{
    ...
    {
        public Guid MulheresId { get; set; }
        ...
        public static Mulheres Adicionar(MembroVm vm)
        {
            return new Mulheres
            {
                MulheresId = Guid.NewGuid(),
        ...
        public static Mulheres AdicionarAutomatico(UsuarioVm vm)
        {
            return new Mulheres
            {
                MulheresId = Guid.NewGuid(),
                ...
                FotoUrl = vm.FotoUrl,
                Ativo = true,
                CargoLocal = CargoLocal.Mulheres,
            };
        }
    }
}